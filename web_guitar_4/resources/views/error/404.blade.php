...
<html>
<head>
    <title>Creative 404 Responsive Error Widget Template | Home :: w3layouts</title>
    <!-- Custom Theme files -->
    <link href="{{url('asset/css/style404Page.css')}}" rel="stylesheet" type="text/css" media="all"/>
    <!-- Custom Theme files -->
...
<div class="not-found">
    ...
    <div class="content">
        <img src="{{url('/images/green.png')}}" alt="" title="">
...
<div class="copyright">
    <p>© 2016 Creative 404. All rights reserved | Design by  <a href="http://w3layouts.com/" target="_blank">  W3layouts </a></p>
</div>
<!--404 page end here-->
</body>
</html>