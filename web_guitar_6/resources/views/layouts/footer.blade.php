@section('footer')
    ...
    <div id="footer" class="">
        <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 footer-left" style="color:white">
            <p>Contact us via any of the following methods during our business hours<br>Monday - Fridat 8:30 AM - 5:30
                PM
                Pacific Time<br>Services@gamingzone.com<br>Phone:1-(626)-854-9338 op. 4</p>
        </div>
